...
// =============================================================================
// CURSOS  — curso.controller.ts  →  @Controller('cursos')
// =============================================================================

export const cursoApi = {
  crear: (dto: CrearCursoDto): Promise<Curso> =>
    request<Curso>('/cursos', { method: 'POST', body: JSON.stringify(dto) }),

  listar: (): Promise<Curso[]> => request<Curso[]>('/cursos'),
};
